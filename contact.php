...
<section class="product-hero animate-fade-up">
  <img src="images/product-detail-hero.jpg" alt="Contact Skan Inc.">
    ...
    <section class="contact-copy animate-on-scroll">
      ...
      <div class="contact-details">
        <div class="contact-detail-card">
          <div class="contact-detail-icon"><img src="images/icon-address.svg" alt=""></div>
          <div>
            <h3>Visit Us</h3>
        ...
        <div class="contact-detail-card">
          <div class="contact-detail-icon"><img src="images/icon-phone.svg" alt=""></div>
          <div>
            <h3>Call Us</h3>
        ...
        <div class="contact-detail-card">
          <div class="contact-detail-icon"><img src="images/icon-email.svg" alt=""></div>
          <div>
            <h3>Email Us</h3>
