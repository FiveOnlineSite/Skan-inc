document.addEventListener('DOMContentLoaded', function () {
  ...
  function getSliderViewportWidth() {
    ...
    return container.clientWidth - parseFloat(styles.paddingLeft) - parseFloat(styles.paddingRight);
  }

  function getCardsPerView() {
    return Math.max(1, Math.min(cards.length, Math.floor((getSliderViewportWidth() + 20) / getCardWidth())));
  }
